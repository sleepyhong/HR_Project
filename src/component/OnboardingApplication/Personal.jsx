    ...
    return (
        <Accordion.Item eventKey="6">
            ...
            <Accordion.Body>
                ...
                <input type="date" id="dateOfBirth" name="dateOfBirth" class="form-control" required value={store.getState().dateOfBirth} disabled={store.getState().applicationStatus === "Pending"} />
