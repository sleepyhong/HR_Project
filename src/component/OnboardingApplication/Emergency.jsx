                    ...
                    userInfo.emergencyContact.map((element, index) => {
                        return (
                            <div>
                                ...
                                <input type="tel" id={`emergencyCellPhone${index}`} name={`emergencyCellPhone${index}`} className="form-control" placeholder="123-456-7890" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required defaultValue={element.phone ? element.phone.substr(0, 12) : ""} disabled={store.getState().applicationStatus === "Pending"} />
